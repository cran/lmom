      subroutine dqagse(a,b,epsabs,epsrel,limit,result,abserr,neval,
...
c                     vector of dimension at least limit, the first and
...
c
      ...
      oflow = d1mach(2)
      ierro = 0
      call dqk21(a,b,result,abserr,defabs,resabs,ienv)
c
c           test on accuracy.
c
      dres = dabs(result)
...
c
        ...
        b2 = blist(maxerr)
        erlast = errmax
        call dqk21(a1,b1,area1,error1,resabs,defab1,ienv)
        call dqk21(a2,b2,area2,error2,resabs,defab2,ienv)
c
