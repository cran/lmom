...
c
      ...
      call dqk15i(boun,inf,0.0d+00,0.1d+01,result,abserr,
     *  defabs,resabs,ienv)
c
c           test on accuracy
c
...
c
        ...
        b2 = blist(maxerr)
        erlast = errmax
        call dqk15i(boun,inf,a1,b1,area1,error1,resabs,defab1,ienv)
        call dqk15i(boun,inf,a2,b2,area2,error2,resabs,defab2,ienv)
c
